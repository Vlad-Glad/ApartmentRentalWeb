...
namespace ApartmentRental.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price,City,FullAddress,Latitude,Longitude,LessorId")] Apartment apartment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Price,City,FullAddress,Latitude,Longitude,LessorId")] Apartment apartment)
        {
            if (id != apartment.Id)
            {
                return NotFound();
